...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    /**  [HQ_GESTURE_DOUBLE_CLICK_HOME] start  Chris  **/
    boolean mLaunchCamera = false;
	/**  [HQ_GESTURE_DOUBLE_CLICK_HOME] end  **/
    ...
    public void layoutWindowLw(WindowState win, WindowManager.LayoutParams attrs,
        ...
        /// M: [ALPS00805067]Let IME involve visibleFrame computation earlier
    ...
    public void notifyLidSwitchChanged(long whenNanos, boolean lidOpen) {
		...
		if(getFactoryKitMode()==1){    //in factorymode,hall test  
		    Intent intent = new Intent();
		    intent.setAction("android.huaqinfactory.action.HALL_DISCOVERED");
        ...
        if(FeatureOption.HQ_HALL_AUTO_WAKEUPSLEEP){
            if (lidOpen) {
    ...
    private int getFactoryKitMode()
    {
        ...
        Log.d("lee", "getFactoryKitMode:result:" + result);
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags, boolean isScreenOn) {
        ...
        /// @}
        /*[FACTORY_TEST_BY_APK] modify start*/
	if(KeyEvent.KEYCODE_POWER == event.getKeyCode() && (getFactoryKitMode() == 1) && (1 == Settings.System.getInt(mContext.getContentResolver(),"sys.factorytest.status",0)))
	{
	...
	/*[FACTORY_TEST_BY_APK] modify end*/
        ...
        final boolean keyguardActive = (mKeyguardMediator == null ? false :
			...
			Log.d("HQ_GESTURE_DOUBLE_CLICK_HOME", "sanlei  interceptKeyBeforeQueueing	111111!!!");

		if (FeatureOption.HQ_GESTURE_DOUBLE_CLICK_HOME) {
			if (keyCode == KeyEvent.KEYCODE_F3 && !isScreenOn) {
				policyFlags |= WindowManagerPolicy.FLAG_WAKE;
				Log.d("HQ_GESTURE_DOUBLE_CLICK_HOME", "sanlei  interceptKeyBeforeQueueing   KEYCODE_F3!!!");
			}
		}
        ...
        if (keyCode == KeyEvent.KEYCODE_POWER) {
            policyFlags |= WindowManagerPolicy.FLAG_WAKE;
            if (FeatureOption.HQ_GESTURE_DOUBLE_CLICK_HOME) {
			Log.d("HQ_GESTURE_DOUBLE_CLICK_HOME", "sanlei interceptKeyBeforeQueueing   KEYCODE_POWER!!!");
            	}
        }
 ...
 /** [HQ_VIRTUAL_VIRBATE_ON] xiehongbin 20130916modify start */
	if (FeatureOption.HQ_VIRTUAL_VIRBATE_ON){
	    if (down &&((keyCode == KeyEvent.KEYCODE_HOME)||(keyCode == KeyEvent.KEYCODE_MENU)
...
/** [HQ_VIRTUAL_VIRBATE_ON] xiehongbin 20130916 smodify end */
        ...
        switch (keyCode) {
		    ...
		    case KeyEvent.KEYCODE_F3:
				if (down && mLaunchCamera && (FeatureOption.HQ_GESTURE_DOUBLE_CLICK_HOME)) {
				    Log.d(TAG, "Launch Camera!!!");
				    try {
				            Intent mIntent = new Intent();
					    mIntent.setClassName("com.android.gallery3d","com.android.camera.CameraLauncher");
					    mIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
					    mIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						int ifromdoublehome = 1;
						mIntent.putExtra("fromdoublehome", ifromdoublehome);

						Log.d("HQ_GESTURE_DOUBLE_CLICK_HOME", "sanlei  startActivity Camera!!!");
						if (FeatureOption.HQ_GESTURE_DOUBLE_CLICK_HOME) {
    ...
    private boolean isWakeKeyWhenScreenOff(int keyCode) {
	        ...
	        switch (keyCode) {
				...
				//wangzong20130926 add for AW9136 	
