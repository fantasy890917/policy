    ...
    private void handleConnectivityChange(int netType, boolean doReset) {
        ...
        if (resetMask != 0 || resetDns) {
            ...
            if (linkProperties != null) {
                ...
                ///M: Handle disconnect event due to the link property may be cleared by NetworkStateTracker @{
                if (iface == null && curLp != null) {
                    log("Get iface from curLp");
                    iface = curLp.getInterfaceName();
                }
                ///@}
...
//                }
   ...
   private void handleMobileDataConnectionChange(int preSlotId, int slotId) {
    ...
    private void setMtuSize(NetworkStateTracker nt){
        ...
        networkRat = mNetworkInfo.getSubtype();
        ...
        log("configure mtu size for " + mNetworkInfo.getType() + " with mtu size:" + mtuSize + ":" + interfaceName);
