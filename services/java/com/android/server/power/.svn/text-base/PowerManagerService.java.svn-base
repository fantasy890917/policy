...
public final class PowerManagerService extends IPowerManager.Stub
    ...
    /** [HQ_APP_FLASHLIGHT] modify start */
    private LightsService.Light mTorchLight; 
    /** [HQ_APP_FLASHLIGHT] modify end */
        ...
        synchronized (mLock) {
            ...
            if (DEBUG_SPEW) {
                Slog.d(TAG, "releaseWakeLockInternal: lock=" + Objects.hashCode(lock)
                        + ", flags=0x" + Integer.toHexString(flags) + ", tag=" + wakeLock.mTag + ", total_time=" + wakeLock.mTotalTime + "ms");
            }
    ...
    private boolean userActivityNoUpdateLocked(long eventTime, int event, int flags, int uid) {
		...
		//[HQ_OPLUS_KEY_BACK_LIGHT_SYNC_TOUCHSCREEN]{a515,oplus} make touchscreen and key blacklight sync  --- maxiaohui 20131008
		if(FeatureOption.HQ_OPLUS_KEY_BACK_LIGHT_SYNC_TOUCHSCREEN){
		
			mLastUserActivityButtonTime = eventTime;
			Log.d("MXH","mLastUserActivityButtonTime="+mLastUserActivityButtonTime);
		}
		//[HQ_OPLUS_KEY_BACK_LIGHT_SYNC_TOUCHSCREEN]{a515,oplus} make touchscreen and key blacklight sync  --- maxiaohui 20131008
    ...
    /** [HQ_APP_FLASHLIGHT] modify start */
    public void setLightDeviceBrightness(int mask, int value) {
        mContext.enforceCallingOrSelfPermission(android.Manifest.permission.DEVICE_POWER, null);
        if ((mask & PowerManager.TORCH_BRIGHTNESS_BIT) != 0) {
            mTorchLight.setBrightness(value);
        }
    }
    /** [HQ_APP_FLASHLIGHT] modify end */
    /**
